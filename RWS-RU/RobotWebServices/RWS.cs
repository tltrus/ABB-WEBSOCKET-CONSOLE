...
{
    /// <summary>
    /// Основной класс для работы с Robot Web Services ABB
    /// </summary>
    public partial class RWSClient : IDisposable
    {
        ...
        /// <summary>
        /// Конструктор клиента RWS
        /// </summary>
        /// <param name="baseUrl">Базовый URL контроллера (например, "http://192.168.125.1")</param>
        /// <param name="username">Имя пользователя (по умолчанию "Default User")</param>
        /// <param name="password">Пароль (по умолчанию "robotics")</param>
        ...
        /// <summary>
        /// Подключение к WebSocket для получения событий
        /// </summary>
        ...
        /// <summary>
        /// Получение событий из WebSocket
        /// </summary>
